...
def generate_instagram(state: OverallState):
    ...
    - Call-to-action to engage with post
    ...
    print("Instagram Generator: Completed\n")

    return {"instagram_post": instagram_post}

def generate_twitter(state: OverallState):
    ...
    print("Twitter Generator: Completed\n")

    return {"twitter_post": twitter_post}

def generate_linkedin(state: OverallState):
    ...
    print("LinkedIn Generator: Completed\n")

    return {"linkedin_post": linkedin_post}

def aggregate_posts(state: OverallState):
